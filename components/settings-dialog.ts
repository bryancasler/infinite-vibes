...
import type { GenerationSettings, VisualizerConfig, VisualizationMode } from '../types.js';
...
export class SettingsDialog extends LitElement {
  ...
  @property({ type: Object }) settings: GenerationSettings | null = null;
  @property({ type: Object }) visualizerConfig: VisualizerConfig | null = null;
  ...
  private handleSettingChange(key: keyof GenerationSettings, value: unknown): void {
    if (this.settings) {
      this.orchestrator.updateSettings({ [key]: value });
    }
  }

  private handleVisualizerChange(key: keyof VisualizerConfig, value: unknown): void {
  ...
  private getVisualizationModes(): { value: VisualizationMode; label: string }[] {
    return [
      ...
      <div class="content">
        ...
        <div class="section">
          ...
          <div class="setting-row">
            ...
            >
              ${MUSICAL_SCALES.map(
                (scale) =>
                  html`<option value=${scale.value}>${scale.label}</option>`
              )}
            </select>
          </div>
          ...
          <div class="setting-row">
            ...
            <div
              ...
              @click=${() =>
                this.handleSettingChange('muteBass', !this.settings!.muteBass)}
            >
          ...
          <div class="setting-row">
            ...
            <div
              ...
              @click=${() =>
                this.handleSettingChange('muteDrums', !this.settings!.muteDrums)}
            >
              <div class="toggle-knob"></div>
            </div>
          </div>
        ...
        <div class="section">
          ...
          <div class="button-group" style="margin-bottom: 1rem;">
            ${this.getVisualizationModes().map(
              (mode) => html`
                <button
