 ...
 */
export function uint8ArrayToInt16Array(uint8Array) {
 ...
 */
export function int16ArrayToFloat32Array(int16Array) {
 ...
 */
export function base64PcmToFloat32(base64) {
 ...
 */
export function createAudioBuffer(audioContext, data, sampleRate = AUDIO_CONFIG.SAMPLE_RATE) {
    const audioBuffer = audioContext.createBuffer(AUDIO_CONFIG.CHANNELS, data.length, sampleRate);
 ...
 */
export function decodeBase64ToAudioBuffer(audioContext, base64, sampleRate = AUDIO_CONFIG.SAMPLE_RATE) {
 ...
 */
export function applyCrossfade(current, next, fadeSamples) {
    return {
 ...
 */
export function normalize(data, targetPeak = 0.95) {
 ...
 */
export function concatenateAudioData(...arrays) {
 ...
 */
export function mixAudioData(...arrays) {
    if (arrays.length === 0) {
 ...
 */
export function createSilence(durationMs, sampleRate = AUDIO_CONFIG.SAMPLE_RATE) {
